package com.jaxws.jobhaven.api;
 ...
 * @author NetshiaR2
 */
public class JobhavenSOAPHandler implements javax.xml.ws.handler.soap.SOAPHandler<SOAPMessageContext>{

    @Override
   public boolean handleMessage(SOAPMessageContext context) {
      
	System.out.println("Server : handleMessage()......");
        // write on the logs file.      
